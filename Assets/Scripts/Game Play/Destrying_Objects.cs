...
public class Destrying_Objects : MonoBehaviour
{
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(Destrying_Objects original)
        {
            ...
            var meshDestroy = GameObject.AddComponent<Destrying_Objects>();
