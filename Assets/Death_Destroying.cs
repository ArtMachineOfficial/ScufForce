...
public class Death_Destroying : MonoBehaviour
{
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(Death_Destroying original)
        {
            ...
            var meshDestroy = GameObject.AddComponent<Death_Destroying>();
            meshDestroy.CutCascades = original.CutCascades;
            meshDestroy.ExplodeForce = original.ExplodeForce;
            GameObject.AddComponent<DestroyAfterDelay>().delay = 5f;
        }
    }
    private class DestroyAfterDelay : MonoBehaviour
    {
